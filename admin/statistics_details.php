...
LEFT JOIN coursesession ON assiduite.id_course = coursesession.id_seance
where assiduite.id_course IN (" . implode(',', array_map('intval', $list_id)) . ") ORDER BY id_etudiant";
